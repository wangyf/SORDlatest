...
!case( 'skepb');         read( str, *, iostat=ios ) key, op, skepb
case( 'friction' );     read( str, *, iostat=ios ) key, op, friction
case( 'intype' );     read( str, *, iostat=ios ) key, op, intype
case( 'mech' );         read( str, *, iostat=ios ) key, op, mech
...
case( 'psidelts' );     read( str, *, iostat=ios ) key, op, psidelts
...
case( 'attenuation' );  read( str, *, iostat=ios ) key, op, attenuation
case( 'fac' );          read( str, *, iostat=ios ) key, op, fac
case( 'q0' );           read( str, *, iostat=ios ) key, op, q0
case( 'ex' );           read( str, *, iostat=ios ) key, op, ex
case( 'fp' );           read( str, *, iostat=ios ) key, op, fp
case default
    select case( key(1:1) )
    case( '=', '+' )
        call pappend
