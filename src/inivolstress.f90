...
i2 = i2node
if ( ic == id ) then
!	if(ic ==2) write(0,*) z1(30,irup-1:irup+1,2,2)
    call diffcn( s1, z1, ic, id, i1, i2, oplevel, bb, xx, dx1, dx2, dx3, dx )
!	if(ic ==2) write(0,*) s1(30,irup:irup+1,2)
else
    i = 6 - ic - id
...
! I comment this line because it's not right in antiplane 2D case. This will miss the
! normal traction when bc1 and bc2 == -1
