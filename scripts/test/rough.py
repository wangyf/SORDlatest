...
p2_ = ihypo[0] + 15000.0 / dx[0], ihypo[1], ihypo[2], () # mode II point indices
p3_ = ihypo[0] - 15000.0 / dx[0], ihypo[1], ihypo[2], () # mode II point indices

p4_ = ihypo[0], ihypo[1] + 5000.0 / dx[1], ihypo[2], () # mode III point indices
p5_ = ihypo[0], ihypo[1] - 5000.0 / dx[1], ihypo[2], () # mode III point indices
p6_ = ihypo[0] + 15000.0 / dx[0], ihypo[1] + 5000.0 / dx[1], ihypo[2], () # mode III point indices
p7_ = ihypo[0] + 15000.0 / dx[0], ihypo[1] - 5000.0 / dx[1], ihypo[2], () # mode III point indices
p8_ = ihypo[0] - 15000.0 / dx[0], ihypo[1] + 5000.0 / dx[1], ihypo[2], () # mode III point indices
p9_ = ihypo[0] - 15000.0 / dx[0], ihypo[1] - 5000.0 / dx[1], ihypo[2], () # mode III point indices
